              ...
              <div className="sm:flex sm:items-start">
                <div className="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left w-full">
                  ...
                  >
                    ...
                    <div className="mb-5">
                      <label htmlFor="descripcion" className='text-gray-700 uppercase font-bold text-sm'>Descripción Tarea:</label>
                      <textarea
                        type="text"
                        id='descripcion'
                    ...
                    <div className="mb-5">
                      <label htmlFor="fecha-entrega" className='text-gray-700 uppercase font-bold text-sm'>Fecha de entreta:</label>
                      <input
                        type="date"
                        id='fecha-entrega'
                        className='border-2 w-full p-2 mt-2 placeholder-gray-400 rounded-md'
